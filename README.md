...
1. Не переводите текст в блоках кода.
2. Замените все идентификаторы, содержащие "en-", на "ru-" (en-about -> ru-about)
...
1. Не переводите текст в блоках кода.
2. Замените все идентификаторы, содержащие "en-", на "ru-" (например: 'en-about' -> 'ru-about')
